<?php
/* Smarty version 3.1.29, created on 2016-05-17 11:14:18
  from "F:\server\www\leiliang\mtwp\Application\View\Home\shopping\shopping.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_573a8c8a64f873_76199350',
  'file_dependency' => 
  array (
    '03cf8e731e13272315679b8fd632373ea00188f5' => 
    array (
      0 => 'F:\\server\\www\\leiliang\\mtwp\\Application\\View\\Home\\shopping\\shopping.html',
      1 => 1463454676,
      2 => 'file',
    ),
  ),
...
function content_573a8c8a64f873_76199350 ($_smarty_tpl) {
$_smarty_tpl->ext->_inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->ext->_inheritance->processBlock($_smarty_tpl, 0, 'content', array (
  0 => 'block_8414573a8c8a60d1e8_37802234',
  1 => false,
  3 => 0,
  2 => 0,
));
...
function block_8414573a8c8a60d1e8_37802234($_smarty_tpl, $_blockParentStack) {
?>
...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-add">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <form class="am-form" action="index.php?p=Home&c=shopping&a=edit" method="post" enctype="multipart/form-data">
                <div>
                ...
                <input type="hidden" name="shop_id" value="<?php echo $_smarty_tpl->tpl_vars['row1']->value['shop_id'];?>
">
...
?>
    <tr style="text-align: center;">
        ...
        <td style="vertical-align: middle;"><?php echo $_smarty_tpl->tpl_vars['row']->value['status'];?>
            ...
            <div> <button <?php if ($_smarty_tpl->tpl_vars['row']->value['status'] == '完成') {?>disabled="disabled"<?php }?>
                    type="button"
...
<div>
    <div class="am-fr" style="margin-right: 50px">
        <ul class="am-pagination" style="display: inline-block">
            <li <?php if ($_smarty_tpl->tpl_vars['page']->value == 1) {?>class="am-disabled"<?php }?>><a href="index.php?p=Home&c=shopping&a=list&page=<?php echo $_smarty_tpl->tpl_vars['page']->value-1;?>
">«</a></li>
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
            <li <?php if ($_smarty_tpl->tpl_vars['page']->value == $_smarty_tpl->tpl_vars['i']->value) {?>class="am-active"<?php }?>><a href="index.php?p=Home&c=shopping&a=list&page=<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
...
?>
            ...
            <li <?php if ($_smarty_tpl->tpl_vars['page']->value == $_smarty_tpl->tpl_vars['total_pages']->value) {?>class="am-disabled"<?php }?>><a href="index.php?p=Home&c=shopping&a=list&page=<?php echo $_smarty_tpl->tpl_vars['page']->value+1;?>
">»</a></li>
        </ul>
...
<?php echo '<script'; ?>
 type="text/javascript">
    function check(){
        ...
        location.href="index.php?p=Home&c=shopping&a=list&page="+oIpt;
    }
<?php echo '</script'; ?>
>
<?php
